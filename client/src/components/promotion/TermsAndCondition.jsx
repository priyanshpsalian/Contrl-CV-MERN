            ...
            <div className="card-body">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        This Terms and Conditions agreement as been created with the help of{' '}
                    ...
                    <li>
                        <strong>Website</strong> refers to Contrl CV, accessible from http://contrlcv.tk/
                    </li>{' '}
                    <li>
                ...
                <ul>
                    <li>By email: contact@contrlcv.tk</li>
                </ul>
            </div>
        </div>
    );
