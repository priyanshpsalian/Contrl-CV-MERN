            ...
            <Router>
              ...
              <div className="container">
                ...
                <Switch>
                  ...
                  <Route exact path="/:slug" component={Dump} />
                  <Route component={NotFound} />
                </Switch>
              </div>
              <CookieConsent buttonClasses="btn btn-primary">
                This website uses cookies to enhance the user experience. You
                can review our <Link to="cookie-policy">Cookie policy</Link>
              </CookieConsent>
